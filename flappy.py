...
while True: #laço pricipal q fica repentindo
    ...
    pygame.display.update() #coliçao dos bgl e caso encostar perde

    if (pygame.sprite.groupcollide(bird_group, ground_group, False, False, pygame.sprite.collide_mask) or
        pygame.sprite.groupcollide(bird2_group, ground_group, False, False, pygame.sprite.collide_mask) or
        pygame.sprite.groupcollide(bird2_group, pipe_group , False, False, pygame.sprite.collide_mask) or
